                ...
                <div class="beg-table-box">
                    ...
                    <div class="beg-table-paged">
                        <div class="list-page" align="center">
                            ...
                            <a href="StatisticDepartmentWhereServlet?cp=1">首页</a>
                            <a href="StatisticDepartmentWhereServlet?cp=${cpage-1<1?1:cpage-1}">上一页</a>
                            <a href="StatisticDepartmentWhereServlet?cp=${cpage+1>tpage?tpage:cpage+1}">下一页</a>
                            <a href="StatisticDepartmentWhereServlet?cp=${tpage}">尾页</a>
                        </div>
                    </div>
                </div>
            </div>
