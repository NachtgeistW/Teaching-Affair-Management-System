...
<div style="margin: 15px;">
    ...
    <form class="layui-form" action="editsubmit?sid=${id }" method="post">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="sid" lay-verify="title" autocomplete="off"
                       value="<%=(String)request.getAttribute( "sid")%>" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="birth" lay-verify="title" autocomplete="off"
                       value="<%=(String)request.getAttribute( "birth")%>" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="where" lay-verify="title" autocomplete="off"
                       value="<%=(String)request.getAttribute( "where")%>" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="politics" lay-verify="title" autocomplete="off"
                       value="<%=(String)request.getAttribute( "politics")%>" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="radio" name="sex" value="男" title="男"
                       id="1" <%= (request.getAttribute( "sex").equals("男"))?"checked":"" %>>
                <input type="radio" name="sex" value="女" title="女"
                       id="2" <%= (request.getAttribute( "sex").equals("女"))?"checked":"" %>>
            </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-input-block">
