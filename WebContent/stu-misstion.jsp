				...
				<div align="right">
					...
					<div class="beg-table-paged">
						<div class="list-page" align="center">
							...
							<a href="Selectcurse?cp=1">首页</a>
							<a href="Selectcurse?cp=${cpage-1<1?1:cpage-1}">上一页</a>
							<a href="Selectcurse?cp=${cpage+1>tpage?tpage:cpage+1}">下一页</a>
							<a href="Selectcurse?cp=${tpage}">尾页</a>
						</div>
					</div>
				</div>
					</div>
