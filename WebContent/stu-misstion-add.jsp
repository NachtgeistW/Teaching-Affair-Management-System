    ...
    <form class="layui-form" action="Curseadd?sid=${sid}" onsubmit="return check(this);" method="post">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="ctestway" lay-verify="title" autocomplete="off" placeholder="请输入考核方式"
                       class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="comment" lay-verify="title" autocomplete="off" placeholder="请输入备注"
                       class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
