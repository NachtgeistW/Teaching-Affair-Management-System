        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="name" lay-verify="title" autocomplete="off"
                       placeholder="<%=(String)request.getAttribute( "name")%>" class="layui-input" disabled="disabled">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="id" lay-verify="title" autocomplete="off"
                       placeholder="<%=(String)request.getAttribute( "id")%>" class="layui-input" disabled="disabled">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="did" lay-verify="title" autocomplete="off"
                       placeholder="<%=request.getAttribute( "did")%>" class="layui-input" disabled="disabled">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="sid" lay-verify="title" autocomplete="off"
                       placeholder="<%=(String)request.getAttribute( "sid")%>" class="layui-input" disabled="disabled">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="birth" lay-verify="title" autocomplete="off"
                       placeholder="<%=(String)request.getAttribute( "birth")%>" class="layui-input"
                       disabled="disabled">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="where" lay-verify="title" autocomplete="off"
                       placeholder="<%=(String)request.getAttribute( "where")%>" class="layui-input"
                       disabled="disabled">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="politics" lay-verify="title" autocomplete="off"
                       placeholder="<%=(String)request.getAttribute( "politics")%>" class="layui-input"
                       disabled="disabled">
            </div>
        </div>
