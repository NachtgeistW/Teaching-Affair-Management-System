                                    ...
                                    <tr>
                                        ...
                                        <td align="right">
                                            <a class="layui-btn layui-btn-primary layui-btn-xs"
                                               href="Teacherselectperson?tid=${teacher.getTeacherId()}">
                                                <i class="layui-icon">&#xe615;</i>查看个人信息
                                            </a>
                                            <a class="layui-btn layui-btn-primary layui-btn-xs"
                                               href="TeacherQueryCourseServlet?tid=${teacher.getTeacherId()}">
                                                <i class="layui-icon">&#xe615;</i>查看授课信息
                                            </a>
                                            <a class="layui-btn layui-btn-primary layui-btn-xs"
                                               href="Teacherselectedit?tid=${teacher.getTeacherId()}">
                                                <i class="layui-icon">&#xe642;</i>修改个人信息
                                            </a>
                                            <a class="layui-btn layui-btn-primary layui-btn-xs"
                                               href="Teacherselectcurselist?tid=${teacher.getTeacherId()}">
