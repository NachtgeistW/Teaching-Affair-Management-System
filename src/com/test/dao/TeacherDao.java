...
public interface TeacherDao extends Dao {
    ...
    List<Teacher> queryAllTeacher() throws SQLException;

    //查询授课信息
    List<TeacherQuery> queryCourseList(String teacherList) throws SQLException;

    //查询课程平均成绩和不及格人数
    List<TeacherQuery> queryCourseAvgGrade(String teacherList) throws SQLException;
}
