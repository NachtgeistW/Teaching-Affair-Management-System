...
<html >
	...
	<body >
		<div class="layui-layout layui-layout-admin" >
			...
			<form action="Selectperson" method="get">
				<div class="layui-side layui-bg-black" id="admin-side" >
				<ul class="layui-nav layui-nav-tree" lay-filter="side">
				  <li class="layui-nav-item layui-nav-itemd">
				    <a href="javascript:;">查询</a>
				    <dl class="layui-nav-child">
				      <dd><a href="Selectperson" target="i">查询个人信息</a></dd>
				      <dd><a href="Selectcurse" target="i">查询上课任务</a></dd>
				      <dd><a href="Selectcore" target="i">查询课程成绩</a></dd>
				    </dl>
				  </li>
				  <li class="layui-nav-item" >
				    <a href="javascript:;">修改</a>
				    <dl class="layui-nav-child">
				      <dd><a href="Selectpersonedit" target="i">修改个人信息</a></dd>
				      <dd><a href="Selectcurseedit" target="i">修改上课任务</a></dd>
				    </dl>
				  </li>
				</ul>
			</div>
